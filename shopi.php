...
define('SHOPIFY_API_KEY','fd9ef66e747ba28b32924030a21a7ba8');
define('SHOPIFY_SECRET','d58d169635887ce098f88fed71b08f83');

/* Define requested scope (access rights) - checkout https://docs.shopify.com/api/authentication/oauth#scopes 	*/
define('SHOPIFY_SCOPE','read_orders,write_orders,read_products');	//eg: define('SHOPIFY_SCOPE','read_orders,write_orders');
...
<form action="" method="post">
	...
	<p>
		<input id="shop" name="shop" size="45" type="text" value="testsexshop.myshopify.com" />
